...
name = ["slicing-slices", "making-slices", "nil-slices", "append", "range", "range-condinued", "exercise-slices", "maps", "map-literals", "map-literals-continued", "mutating-maps", "exercise-maps", "function-vavlues", "function-closures", "exercise=fibonacci-closure", "methods", "methods-continued", "methods-with-pointer-receivers", "inferfaces",
